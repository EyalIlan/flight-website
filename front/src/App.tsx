...
function App() {
  ...
  return (
    <div className="app">
      {showFlightLists ? <FlightSelection handleSelectionClick={fetchFlights} /> :
        flightsData && <>
          ...
          {isFlightModalOpen && selectedFlight && <Modal flight={selectedFlight} isOpen={isFlightModalOpen} />}
        </>}
    </div>
  );
}
